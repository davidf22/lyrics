...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  ...
  >
    ...
    <div className="flex-1 flex flex row justify-between items-center">
      <img className="w-20 h-20 rounded-lg" src="src/assets/images/David Fayankin's Top Playlist.png" alt={song?.title} />
...
const TopPlay = () => {
  ...
  return (
    <div ref={divRef} className="xl:ml-6 ml-o xl: mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col">
        ...
        >
          {topPlays?.map((song, i) => (
            ...
            >
              <Link to="/artists/">
                <img
                  src="src/assets/images/David Fayankin's Top Playlist.png"
                  alt="name"
